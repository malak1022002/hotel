...
$id = $_GET['id'];                  
$query = "Select * from facilities_article where id = $id";
          ...
          <div class="card">
           <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0">EDIT TITLE</h5>
            </div>
            <form action="update_title.php?id=<?= $id ?>" method="post">
          <div class="mb-3">
            <label class="form-label">Article</label>
            <textarea name="article"  class="form-control shadow-none" 
           rows="6" required><?= $row['article'] ?></textarea>
          </div>
          <div class="modal-footer">
          <button type="button" onclick="window.location.href='title.php'" class="btn text-secondary shadow-none">CANSEL</button>
