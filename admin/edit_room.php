...
<head>
    ...
    <title>Admin Panel - Edit_Room</title>
      ...
      <div class="row">         
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
          ...
          <div class="card">
           <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0">Edit Room</h5>
            </div>
            <form action="update_room.php?id=<?= $id ?>" method="post">
            <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="adult" value="<?= $row['adult'] ?>" 
            class="form-control shadow-none" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="children" value="<?= $row['children'] ?>" 
            class="form-control shadow-none" required>
          </div>
