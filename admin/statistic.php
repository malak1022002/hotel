  ...
  <div class="container-fluid flex-lg-column align-items-stretch">
    ...
    <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
     <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link text-white active" href="statistic.php">Statistic</a>
      </li>
      <li class="nav-item">
...
<!--<div class="modal fade" id="team_s" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="card border-0 shadow-sm">
           <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0">STATISTIC</h5>
              <button type="button" class="btn btn-dark shadow-none btn-sm">
              <a href="add_statistic.php" class="text-white text-decoration-none">
  ...
  <?php
    ...
    <tr>
      <td><?= $id ?></td>
      <td><?= $article ?></td>
      <td><img src="assets/images/<?= $row['image'] ?>"class="imgf"></td>
      <td><a href="delete_statistic.php?id=<?= $row['id'] ?>" onclick="return confirm('Are You Sure To Delete This Record!')">
