...
if(isset($_POST['btnadd'])){
    //echo "Button Clicked";
    $fname = $_POST['fname'];
    $sql = "insert into add_features (fname)
             values('$fname')";
    $result = dbQuery($sql);
    if($result){
    ...
    <div class="container-fluid" id="main-content">
      <div class="row">         
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
          ...
          <div class="card">
           <div class="card-body bg-dark shadow">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0 text-white">ADD FEATURES</h5>
            </div>
          ...
          <button type="button" onclick="window.location.href='features_facilities.php'" class="btn text-white shadow-none">CANSEL</button>
