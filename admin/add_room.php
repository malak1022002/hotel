...
if(isset($_POST['btnadd'])){
    ...
    $sql = "insert into rooms (fname, area, price, adult, children)
             values('$fname', '$area', '$price', '$adult', '$children')";
    $result = dbQuery($sql);
    if($result){
    ...
    <div class="container-fluid" id="main-content">
      <div class="row">         
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
          <h3 class="mb-4 text-light">FEATURES</h3>
          <div class="card">
           <div class="card-body bg-dark">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0 text-light">ADD FEATURES</h5>
            </div>
          ...
          <div class="mb-3">
            <label class="form-label text-light">Adult (Max.)</label>
          ...
          <div class="mb-3">
            <label class="form-label text-light">Children (Max.)</label>
          ...
          <div class="mb-3">
            <label class="form-label text-light">Facilities</label>
            <br>
            <?php room_facilities(); ?>
          </div>
          <div class="mb-3">
          ...
          <button type="button" onclick="window.location.href='room.php'" class="btn text-secondary shadow-none">CANSEL</button>
