        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
          ...
          <div class="card">
           <div class="card-body">
            ...
            <input type="text" name="site_title" value="<?= $row['site_title'] ?>" 
            class="form-control shadow-none" placeholder="please Enter title">
            <span class="text-danger"><?= $errtit ?></span>
          </div>
          <div class="mb-3">
            <label class="form-label">About us</label>
            <textarea name="site_about"  class="form-control shadow-none" 
            placeholder="please Enter about" rows="6"><?= $row['site_about'] ?></textarea>
            <span class="text-danger"><?= $errabout ?></span>
          </div>
