...
<!--<div class="modal fade" id="team_s" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="card border-0 shadow-sm">
           <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <a href="add_about_title.php" class="text-white text-decoration-none">
  ...
  <?php
    ...
    <tr>
      ...
      <td><a href="delete_about_title.php?id=<?= $row['id'] ?>" onclick="return confirm('Are You Sure To Delete This Record!')">
