  ...
  <div class="container-fluid flex-lg-column align-items-stretch">
    ...
    <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
     <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link text-white active" href="user.php">Users</a>
      </li>
      <li class="nav-item">
    ...
    <div class="container-fluid bg-dark" id="main-content">
      <div class="row">
...
<!--<div class="modal fade" id="team_s" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="card border-0 shadow-sm">
           <div class="card-body bg-dark">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0 text-white">USERS</h5>
            </div>
  ...
  <?php
    if(Connect()){      
                  ...
                  $start = ($page - 1) * $noOfRows;
                     $sql = "SELECT * FROM `user_send` limit $start, $noOfRows";
                     $rs = dbQuery($sql);
