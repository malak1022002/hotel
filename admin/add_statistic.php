...
if(isset($_POST['btnadd'])){
    ...
    $sql = "insert into statistic (article, image)
    ...
    <div class="container-fluid" id="main-content">
      <div class="row">         
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
          ...
          <button type="button" onclick="window.location.href='statistic.php'" class="btn text-secondary shadow-none">CANSEL</button>
